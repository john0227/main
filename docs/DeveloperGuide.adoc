...
Alternative 2 was chosen for obvious reasons. Additional overhead of `Path` class (`File` class could also have been used) proved more effective than storing as `Strings`.
